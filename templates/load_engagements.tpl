{if $total > 0 }
  ...
  <tr>
    ...
    <td>
      {if $engagement->synced}Yes <a href="#" rel="popover" title="Synchronized" data-html="true" data-content="salt: {$engagement->synced} <a class='btn btn-small btn-warning' href='#'>Send</a>"><i class="icon-info-sign"></i></a>{/if}
    </td>
    <td>
      <div class="btn-group">
